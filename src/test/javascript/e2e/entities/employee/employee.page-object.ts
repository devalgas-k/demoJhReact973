...
export class EmployeeDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('demoJhReact973App.employee.delete.question'));
...
export default class EmployeeComponentsPage {
  ...
  async deleteEmployee() {
    ...
    expect(await employeeDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/demoJhReact973App.employee.delete.question/);
