...
export class CountryDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('demoJhReact973App.country.delete.question'));
...
export default class CountryComponentsPage {
  ...
  async deleteCountry() {
    ...
    expect(await countryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/demoJhReact973App.country.delete.question/);
