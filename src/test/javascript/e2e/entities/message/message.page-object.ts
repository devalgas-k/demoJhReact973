...
export class MessageDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('demoJhReact973App.message.delete.question'));
...
export default class MessageComponentsPage {
  ...
  async deleteMessage() {
    ...
    expect(await messageDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/demoJhReact973App.message.delete.question/);
