...
export class LocationDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('demoJhReact973App.location.delete.question'));
...
export default class LocationComponentsPage {
  ...
  async deleteLocation() {
    ...
    expect(await locationDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/demoJhReact973App.location.delete.question/);
