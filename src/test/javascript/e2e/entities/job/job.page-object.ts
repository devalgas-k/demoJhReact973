...
export class JobDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('demoJhReact973App.job.delete.question'));
...
export default class JobComponentsPage {
  ...
  async deleteJob() {
    ...
    expect(await jobDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/demoJhReact973App.job.delete.question/);
