...
export const LocationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demoJhReact973App.location.delete.question">
        <Translate contentKey="demoJhReact973App.location.delete.question" interpolate={{ id: locationEntity.id }}>
