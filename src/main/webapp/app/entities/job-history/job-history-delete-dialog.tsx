...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demoJhReact973App.jobHistory.delete.question">
        <Translate contentKey="demoJhReact973App.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
