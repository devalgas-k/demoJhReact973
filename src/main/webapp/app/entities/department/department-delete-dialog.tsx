...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demoJhReact973App.department.delete.question">
        <Translate contentKey="demoJhReact973App.department.delete.question" interpolate={{ id: departmentEntity.id }}>
