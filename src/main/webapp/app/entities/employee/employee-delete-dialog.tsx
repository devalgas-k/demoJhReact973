...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demoJhReact973App.employee.delete.question">
        <Translate contentKey="demoJhReact973App.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
