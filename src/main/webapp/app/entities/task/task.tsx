        ...
        {taskList && taskList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="demoJhReact973App.task.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="demoJhReact973App.task.title">Title</Translate>
                </th>
                <th>
                  <Translate contentKey="demoJhReact973App.task.description">Description</Translate>
                </th>
                <th />
              </tr>
            </thead>
