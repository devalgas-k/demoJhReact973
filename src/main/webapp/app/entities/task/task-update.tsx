  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="demoJhReact973App.task.home.createOrEditLabel" data-cy="TaskCreateUpdateHeading">
            <Translate contentKey="demoJhReact973App.task.home.createOrEditLabel">Create or edit a Task</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
