...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './expertise.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXPERTISE_LIST actions', async () => {
    ...
    it('dispatches FETCH_EXPERTISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXPERTISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXPERTISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXPERTISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXPERTISE actions', async () => {
      const expectedActions = [
        {
