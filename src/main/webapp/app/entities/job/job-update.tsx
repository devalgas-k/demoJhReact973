  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="demoJhReact973App.job.home.createOrEditLabel" data-cy="JobCreateUpdateHeading">
            <Translate contentKey="demoJhReact973App.job.home.createOrEditLabel">Create or edit a Job</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('demoJhReact973App.job.jobTitle')}
                id="job-jobTitle"
                name="jobTitle"
                data-cy="jobTitle"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('demoJhReact973App.job.maxSalary')}
                id="job-maxSalary"
                name="maxSalary"
                data-cy="maxSalary"
                type="text"
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('demoJhReact973App.job.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
