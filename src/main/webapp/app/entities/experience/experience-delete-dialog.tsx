...
export const ExperienceDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demoJhReact973App.experience.delete.question">
        <Translate contentKey="demoJhReact973App.experience.delete.question" interpolate={{ id: experienceEntity.id }}>
